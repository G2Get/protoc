...
func (x *RgisterRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RgisterRequest) ProtoMessage() {}

func (x *RgisterRequest) ProtoReflect() protoreflect.Message {
	mi := &file_sso_sso_proto_msgTypes[0]
...
// Deprecated: Use RgisterRequest.ProtoReflect.Descriptor instead.
func (*RgisterRequest) Descriptor() ([]byte, []int) {
	return file_sso_sso_proto_rawDescGZIP(), []int{0}
}

func (x *RgisterRequest) GetEmail() string {
	if x != nil {
		return x.Email
	}
	return ""
...
func (x *RgisterRequest) GetPassword() string {
	if x != nil {
		return x.Password
	}
	return ""
...
var file_sso_sso_proto_rawDesc = []byte{
	...
	0x04, 0x61, 0x75, 0x74, 0x68, 0x22, 0x42, 0x0a, 0x0e, 0x52, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72,
	...
	0xaa, 0x01, 0x0a, 0x04, 0x41, 0x75, 0x74, 0x6f, 0x12, 0x38, 0x0a, 0x08, 0x52, 0x65, 0x67, 0x69,
	0x73, 0x74, 0x65, 0x72, 0x12, 0x14, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x2e, 0x52, 0x67, 0x69, 0x73,
...
var file_sso_sso_proto_goTypes = []interface{}{
	(*RgisterRequest)(nil),   // 0: auth.RgisterRequest
...
var file_sso_sso_proto_depIdxs = []int32{
	0, // 0: auth.Auto.Register:input_type -> auth.RgisterRequest
	2, // 1: auth.Auto.Login:input_type -> auth.LoginRequest
	4, // 2: auth.Auto.IsAdmin:input_type -> auth.IsAdminRequest
	1, // 3: auth.Auto.Register:output_type -> auth.RegisterResponse
	3, // 4: auth.Auto.Login:output_type -> auth.LoginResponse
	5, // 5: auth.Auto.IsAdmin:output_type -> auth.IsAdminResponse
